...
class MyGame(arcade.Window):
    ...
    def update(self, delta_timer):
        ...
        # set a 'dead zone' to prevent drive from a centered joystick
            ...
            #self.ball.change_x = self.joystick.x * MOVEMENT_SPEED # multiply by no. to speed up ball movement
            #self.ball.change_y = -self.joystick.y * MOVEMENT_SPEED # can also set constant variable at top of program and use instead
